...
This module provides functions for text cleaning and preprocessing:
...
def preprocess_pipeline(df, text_column="message"):
    ...
    Returns:
        pd.DataFrame: DataFrame with additional processed_text column
    """
...
if __name__ == "__main__":
    sample_text = "WINNER!! You have won a FREE prize! Call 08001234567 NOW!"
    demonstrate_preprocessing(sample_text)
